...
//Statement Signing
$CFG->privateKeyPassPhrase = "magic";
//Note: if you change this, you will also need to create a new private key (privkey.pem) in the "signing" folder. 

//Open Badges
$CFG->badge_salt = "badge_salt";
$CFG->rebakeBadgeToDisplay= true;
//If false get the badge from the attachment. 
